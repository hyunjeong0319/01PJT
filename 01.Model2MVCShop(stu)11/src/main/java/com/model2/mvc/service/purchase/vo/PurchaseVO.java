...
public class PurchaseVO {
	...
	private UserVO buyer;  //구매자 ID
	private String divyAddr; //구매자 주소
	private String divyDate; //배송날짜
	private String divyRequest;//배송시 요청사항
	private Date orderDate; // 주문날짜
	private String paymentOption; // 구매방법
	private ProductVO purchaseProd; //구매상품번호
	private String receiverName; //구매자 이름
	private String receiverPhone; // 구매자 번호
	private String tranCode; //001
	private int tranNo; //유니크한 번호
